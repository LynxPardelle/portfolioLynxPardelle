  ...
  checkImgWNH(file: BookImg) {
    try {
      ...
      img.onload = (e: any) => {
        ...
        console.log('1 = ' + (this.windowWidth / 12) * 1);
        console.log('2 = ' + (this.windowWidth / 12) * 2);
        console.log('3 = ' + (this.windowWidth / 12) * 3);
        console.log('4 = ' + (this.windowWidth / 12) * 4);
        console.log('5 = ' + (this.windowWidth / 12) * 5);
        console.log('6 = ' + (this.windowWidth / 12) * 6);
        console.log('7 = ' + (this.windowWidth / 12) * 7);
        console.log('8 = ' + (this.windowWidth / 12) * 8);
        console.log('9 = ' + (this.windowWidth / 12) * 9);
        console.log('10 = ' + (this.windowWidth / 12) * 10);
        console.log('11 = ' + (this.windowWidth / 12) * 11);
        console.log('12 = ' + (this.windowWidth / 12) * 12);

        console.log(
          'col-1:' +
            (width < this.windowWidth / 12) +
            'col-2:' +
            (width >= this.windowWidth / 12 &&
              width < (this.windowWidth / 12) * 2) +
            'col-3:' +
            (width >= (this.windowWidth / 12) * 2 &&
              width < (this.windowWidth / 12) * 3) +
            'col-4:' +
            (width >= (this.windowWidth / 12) * 3 &&
              width < (this.windowWidth / 12) * 4) +
            'col-5:' +
            (width >= (this.windowWidth / 12) * 4 &&
              width < (this.windowWidth / 12) * 5) +
            'col-6:' +
            (width >= (this.windowWidth / 12) * 5 &&
              width < (this.windowWidth / 12) * 6) +
            'col-7:' +
            (width >= (this.windowWidth / 12) * 6 &&
              width < (this.windowWidth / 12) * 7) +
            'col-8:' +
            (width >= (this.windowWidth / 12) * 7 &&
              width < (this.windowWidth / 12) * 8) +
            'col-9:' +
            (width >= (this.windowWidth / 12) * 10 &&
              width < (this.windowWidth / 12) * 9) +
            'col-10:' +
            (width >= (this.windowWidth / 12) * 9 &&
              width < (this.windowWidth / 12) * 10) +
            'col-11:' +
            (width >= (this.windowWidth / 12) * 10 &&
              width < (this.windowWidth / 12) * 11) +
            'col-12:' +
            (width >= (this.windowWidth / 12) * 11 &&
