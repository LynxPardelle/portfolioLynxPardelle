  ...
  checkImgWNH(file: BookImg) {
    try {
      ...
      img.onload = (e: any) => {
        ...
        console.log((this.windowWidth / 12) * 1);
        console.log((this.windowWidth / 12) * 2);
        console.log((this.windowWidth / 12) * 3);
        console.log((this.windowWidth / 12) * 4);
        console.log((this.windowWidth / 12) * 5);
        console.log((this.windowWidth / 12) * 6);
        console.log((this.windowWidth / 12) * 7);
        console.log((this.windowWidth / 12) * 8);
        console.log((this.windowWidth / 12) * 9);
        console.log((this.windowWidth / 12) * 10);
        console.log((this.windowWidth / 12) * 11);
        console.log((this.windowWidth / 12) * 12);
