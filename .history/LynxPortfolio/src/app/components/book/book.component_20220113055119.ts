  ...
  checkImgWNH(file: BookImg) {
    try {
      ...
      img.onload = (e: any) => {
        ...
        console.log(this.windowWidth / 12);
        console.log(this.windowWidth / 11);
        console.log(this.windowWidth / 10);
        console.log(this.windowWidth / 9);
        console.log(this.windowWidth / 8);
        console.log(this.windowWidth / 7);
        console.log(this.windowWidth / 6);
        console.log(this.windowWidth / 5);
        console.log(this.windowWidth / 4);
        console.log(this.windowWidth / 3);
        console.log(this.windowWidth / 2);
        console.log(this.windowWidth / 1);
