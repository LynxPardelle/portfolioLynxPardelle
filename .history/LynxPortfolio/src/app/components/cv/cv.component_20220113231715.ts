  ...
  async getCVSections() {
    try {
      ...
      for(let section of this.CVSections){
        colors[section.titleColor] = section.titleColor;
        colors[section.textColor] = section.textColor;
        colors[section.linkColor] = section.linkColor;
        colors[section.bgColor] = section.bgColor;
        for(let subsection of section.CVSubSections){
          colors[subsection.titleColor] = subsection.titleColor;
          colors[subsection.textColor] = subsection.textColor;
          colors[subsection.linkColor] = subsection.linkColor;
          colors[subsection.bgColor] = subsection.bgColor;
        }
      }
