    ...
    try {
      ...
      for (let bef of befs) {
        ...
        if (
          ...
          console.log(befSplited[2]);
          switch (befSplited[1]) {
            case "bg":
              if (value.includes(" OPA")) {
                befStringed += `{background-color: rgba(${await this.HexToRGB(
            ...
            case "bgHover":
              if (value.includes(" OPA")) {
                befStringed += `:hover{background-color: rgba(${await this.HexToRGB(
                  this.colors[value.split(" ")[0]]
                ).toString()}, ${value.split(" ")[2]}) !important;}`;
              } else {
            ...
            case "bgActive":
              if (value.includes(" OPA")) {
                befStringed += `:active{background-color: rgba(${await this.HexToRGB(
                  this.colors[value.split(" ")[0]]
                ).toString()}, ${value.split(" ")[2]}) !important;}`;
              } else {
            ...
            case "text":
              if (value.includes(" OPA")) {
                befStringed += `{color: rgba(${await this.HexToRGB(
                  this.colors[value.split(" ")[0]]
                ).toString()}, ${value.split(" ")[2]}) !important;}`;
              } else {
            ...
            case "textHover":
              if (value.includes(" OPA")) {
                befStringed += `:hover{color: rgba(${await this.HexToRGB(
                  this.colors[value.split(" ")[0]]
                ).toString()}, ${value.split(" ")[2]}) !important;}`;
              } else {
            ...
            case "textActive":
              if (value.includes(" OPA")) {
                befStringed += `:active{color: rgba(${await this.HexToRGB(
                  this.colors[value.split(" ")[0]]
                ).toString()}, ${value.split(" ")[2]}) !important;}`;
              } else {
            ...
            case "link":
              if (value.includes(" OPA")) {
                befStringed = `.${bef} a{color: rgba(${await this.HexToRGB(
                  this.colors[value.split(" ")[0]]
                ).toString()}, ${value.split(" ")[2]}) !important;}`;
              } else {
            ...
            case "linkHover":
              if (value.includes(" OPA")) {
                befStringed = `.${bef} a:hover{color: rgba(${await this.HexToRGB(
                  this.colors[value.split(" ")[0]]
                ).toString()}, ${value.split(" ")[2]}) !important;}`;
              } else {
            ...
            case "linkActive":
              if (value.includes(" OPA")) {
                befStringed = `.${bef} a:active{color: rgba(${await this.HexToRGB(
                  this.colors[value.split(" ")[0]]
                ).toString()}, ${value.split(" ")[2]}) !important;}`;
              } else {
            ...
            case "borderColor":
              if (value.includes(" OPA")) {
                befStringed += `{border-color: rgba(${await this.HexToRGB(
                  this.colors[value.split(" ")[0]]
                ).toString()}, ${value.split(" ")[2]}) !important;}`;
              } else {
            ...
            case "borderColort":
              if (value.includes(" OPA")) {
                befStringed += `{border-top-color: rgba(${await this.HexToRGB(
                  this.colors[value.split(" ")[0]]
                ).toString()}, ${value.split(" ")[2]}) !important;}`;
              } else {
            ...
            case "borderColorb":
              if (value.includes(" OPA")) {
                befStringed += `{border-bottom-color: rgba(${await this.HexToRGB(
                  this.colors[value.split(" ")[0]]
                ).toString()}, ${value.split(" ")[2]}) !important;}`;
              } else {
            ...
            case "borderColors":
              if (value.includes(" OPA")) {
                befStringed += `{border-right-color: rgba(${await this.HexToRGB(
                  this.colors[value.split(" ")[0]]
                ).toString()}, ${value.split(" ")[2]}) !important;}`;
              } else {
            ...
            case "borderColore":
              if (value.includes(" OPA")) {
                befStringed += `{border-left-color: rgba(${await this.HexToRGB(
                  this.colors[value.split(" ")[0]]
                ).toString()}, ${value.split(" ")[2]}) !important;}`;
              } else {
            ...
            case "borderColorx":
              if (value.includes(" OPA")) {
                befStringed += `{border-right-color: rgba(${await this.HexToRGB(
                  ...
                  value.split(" ")[2]
                }) !important;border-left-color: rgba(${await this.HexToRGB(
                  this.colors[value.split(" ")[0]]
                ).toString()}, ${value.split(" ")[2]}) !important;}`;
              } else {
            ...
            case "borderColory":
              if (value.includes(" OPA")) {
                befStringed += `{border-top-color: rgba(${await this.HexToRGB(
                  ...
                  value.split(" ")[2]
                }) !important;border-bottom-color: rgba(${await this.HexToRGB(
                  this.colors[value.split(" ")[0]]
                ).toString()}, ${value.split(" ")[2]}) !important;}`;
              } else {
            ...
            case "btn":
              if (value.includes(" OPA")) {
                befStringed += `{
                  background-color: rgba(${await this.HexToRGB(
                    this.colors[value.split(" ")[0]]
                  ).toString()}, ${value.split(" ")[2]});
                border-color: rgba(${await this.HexToRGB(
                  this.colors[value.split(" ")[0]]
                ).toString()}, ${value.split(" ")[2]});}
                /.${bef}:hover{
                  background-color: rgba(${await this.HexToRGB(
                    await this.shadeTintColor(
                      await this.HexToRGB(this.colors[value.split(" ")[0]]),
                      -15
                    )
                  ).toString()}, ${value.split(" ")[2]});
                border-color: rgba(${await this.HexToRGB(
                ...
                /.${bef}:hover{background-color:${await this.shadeTintColor(
                  await this.HexToRGB(this.colors[value]),
                  -15
                )};border-color:${await this.shadeTintColor(
                  await this.HexToRGB(this.colors[value]),
                  -20
                )};}
                /.btn-check:focus + .${bef}, .${bef}:focus{background-color:${await this.shadeTintColor(
                  await this.HexToRGB(this.colors[value]),
                  -15
                )};border-color:${await this.shadeTintColor(
                  await this.HexToRGB(this.colors[value]),
                ...
                /.btn-check:checked + .${bef}, .btn-check:active + .${bef}, .${bef}:active, .${bef}.active, .show > .${bef}.dropdown-toggle{background-color:${await this.shadeTintColor(
                  await this.HexToRGB(this.colors[value]),
                  -20
                )};border-color:${await this.shadeTintColor(
                  await this.HexToRGB(this.colors[value]),
                ...
                rgba(${await this.HexToRGB(
                  await this.shadeTintColor(await this.HexToRGB(this.colors[value]), 3)
                )}, 0.5)
                ;}
            ...
            case "btnOutline":
              if (value.includes(" OPA")) {
                befStringed += `{
                  color: rgba(${await this.HexToRGB(
                    this.colors[value.split(" ")[0]]
                  ).toString()}, ${value.split(" ")[2]});
                  border-color: rgba(${await this.HexToRGB(
                    this.colors[value.split(" ")[0]]
      ...
      if (befsStringed !== "") {
        for (let bef of befsStringed.split("/")) {
          if (bef !== "") {
            console.log(bef);
            await this.createCSSRules(bef);
          }
        }
      }
      if (befsStringedSM !== "") {
        await this.createCSSRules(
  ...
  async createCSSRules(rule: string) {
    try {
      ...
      if (
        ...
        if(sheet){
          console.log(ruleI);
          await sheet.insertRule(ruleI.replace('\n', '').replace(/\s+/g, ' '), sheet.cssRules.length);
          console.log(sheet);
        }
      }
    } catch (err) {
